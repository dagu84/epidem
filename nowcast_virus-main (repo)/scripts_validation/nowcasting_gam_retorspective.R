...
for (j in datas) {
  ...
  dados2<- dados %>% filter(dt_release<=j)
...
save(big_data_gam, file = paste("validation/GAM_nowcast_sari_viruses_uf_no_fever_filter_2025-07-05_a_2026-06-13.RData"))
save(big_data2_gam, file = paste("validation/trajectories_GAM_nowcast_sari_viruses_uf_no_fever_filter__2025-07-05_a_2026-06-13.RData"))
